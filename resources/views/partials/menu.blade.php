<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <h5  style="margin-top:100px; padding-left: 30px; padding-right: 30px;padding-top: 7px;padding-bottom: 7px; background-color: blue" id="svc">  For users</h5>
       
            <li class="nav-item"  >
                <a href="#" class="nav-link {{ request()->is('admin/my_tickets') || request()->is('admin/tickets/*') ? 'active' : '' }}">
                    <i class="fa-fw fas fa-question-circle nav-icon">
